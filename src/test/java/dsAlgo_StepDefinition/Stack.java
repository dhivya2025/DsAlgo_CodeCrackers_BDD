...
public class Stack {
    ...
    public void the_user_clicks_the_sign_in_link_from_the_portal() {
    	logger.info("Logging ::::::User clicks the Sign In link from the portal");
    ...
    public void user_is_on_the_sign_in_page() {
    	...
    	logger.info("Logging ::::::User is on the signIn page");
    ...
    public void the_user_should_be_able_to_navigate_to_try_editor_page_with_run_button_to_test() {
    	//Assert.assertEquals(stackPage.RunButtonEnabled(),true);
    ...
    public void user_enters_valid_invalid_and_incorrect_syntax_code_from_excel_sheet_and_and_clicks_on_run_button_for_the_operations_in_stack_page(String sheetName, int rowNumber) throws IOException, InterruptedException {
    	stackPage.tryEditorWindow(sheetName, rowNumber);
    	logger.info("Logging ::::::User enters valid, invalid and incorrect syntax code from excel sheet {string} and {int} and clicks on Run button for the Operations in Stack page");
    }
    ...
    public void the_user_should_be_able_to_get_an_output_in_the_try_editor_screen_for_the_operations_in_stack_page() {
    	//Assert.assertEquals(stackPage.OutputWindowDisplayed(),true);
    	logger.info("Logging ::::::user should be able to get an output in the Try Editor screen for the Operations in Stack page");    
    ...
    public void user_enters_valid_invalid_and_incorrect_syntax_code_from_excel_sheet_and_and_clicks_on_run_button_for_the_implementation_page(String sheetName, int rowNumber) throws IOException, InterruptedException {  
    	stackPage.tryEditorWindow(sheetName, rowNumber);
    	logger.info("Logging ::::::User enters valid, invalid and incorrect syntax code from excel sheet {string} and {int} and clicks on Run button for the Implementation page");  
    ...
    public void the_user_should_be_able_to_get_an_output_in_the_try_editor_screen_for_the_implementation_page() {
    	//stackPage.ValidateExcelOutputMessage();
    	logger.info("Logging ::::::user should be able to get an output in the Try Editor screen for the Implementation page");  
    ...
    public void user_enters_valid_invalid_and_incorrect_syntax_code_from_excel_sheet_and_and_clicks_on_run_button_for_the_applications_page(String sheetName, int rowNumber) throws IOException, InterruptedException{
    	stackPage.tryEditorWindow(sheetName, rowNumber);
    	logger.info("Logging ::::::User enters valid, invalid and incorrect syntax code from excel sheet {string} and {int} and clicks on Run button for the Applications page");  
    ...
    public void the_user_should_be_able_to_get_an_output_in_the_try_editor_screen_for_the_applications_page() {
    	//Assert.assertEquals(stackPage.OutputWindowDisplayed(),true);
    	logger.info("Logging ::::::User should be able to get an output in the Try Editor screen for the Applications page");  
    ...
    public void the_user_should_be_redirected_to_practice_page() {
    	//Assert.assertEquals(stackPage.PracticeQuestionsStackDisplayed(),true);
