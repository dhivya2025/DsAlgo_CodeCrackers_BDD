...
public class LinkedList {
    ...
    @Given("User logs into dsalgo portal with valid Username and Password")
    public void user_logs_into_dsalgo_portal_with_valid_username_and_password() {
    ...
    @Then("User should be able to login to the dsalgo portal")
    public void user_should_be_able_to_login_to_the_dsalgo_portal() {
        
    }
    
    @Given("The user is on the Sign In page for Linked List")
    public void the_user_is_on_the_sign_in_page_for_linked_list() {
    	 homePage.launchURL();
	...
	public void user_clicks_on_the_get_started_button_under_linked_list_section() throws InterruptedException {
//		Thread.sleep(3000);
//		linkedListPage.getStartedLinkedListBtnClick();
//		Thread.sleep(3000);
		System.out.println("Before clicking: " + driver.getCurrentUrl());
		linkedListPage.getStartedLinkedListBtnClick();
		Thread.sleep(2000);
...
//		loginPage.excelDataRead(sheetName, rowNumber);
	...
	public void the_user_clicks_in_the_try_editor_screen() {
